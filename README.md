...
Внутри виртуалки находящейся в кластере, состояние кластера можно мониторить скриптом `mon`, находится в /root/bin. Востанавливать БД после того как она рассинхронизировалась можно скриптами типа restore0a, лежат в /root/bin.
