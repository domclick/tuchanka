...
Все скрипты начинающиеся на heart пишут в плавающие IP принадлежащие мастеру соответствующей БД. Скрипты которые начинаются на beat читают из плавающих IP принадлежащих рабам соответствующей БД, за исключением tuchanka1 (т.к. по схеме с уплотнением рабы услуги не оказывают , плавающих IP у рабов нет).
...
- В третьей, на хосте: `heartbeat/beat2` *(мониториг чтения из раба)*
